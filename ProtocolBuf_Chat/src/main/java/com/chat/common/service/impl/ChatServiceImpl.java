...
public class ChatServiceImpl implements ChatService{
    ...
    public void publicChat(long playerId, String content) {
        ...
        //创建消息对象
        ChatModule.ChatResponse chatResponse = ChatModule.ChatResponse.newBuilder()
                .setChatType(ChatModule.ChatType.PUBLIC)
                .setSendPlayerId(playerId)
                .setSendPlayerName(player.getName())
                .setMessage(content)
                .build();
    ...
    public void privateChat(long playerId, long targetPlayerId, String content) {
        ...
        //创建消息对象
        ChatModule.ChatResponse chatResponse = ChatModule.ChatResponse.newBuilder()
                .setChatType(ChatModule.ChatType.PRIVATE)
                .setSendPlayerId(playerId)
                .setSendPlayerName(player.getName())
                .setTargetPlayerName(targetPlayer.getName())
                .setMessage(content)
                .build();
