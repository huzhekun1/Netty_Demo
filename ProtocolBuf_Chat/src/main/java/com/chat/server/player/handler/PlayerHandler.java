...
public interface PlayerHandler {
     ...
     *  创建并登录账号
     * @param session 会话
     * @param data {@link com.chat.common.module.player.proto.PlayerModule.RegisterRequest}
     * @return
     */
     ...
     * 登录账号
     * @param session 会话
     * @param data {@link com.chat.common.module.player.proto.PlayerModule.LoginRequest}
     * @return
     */
